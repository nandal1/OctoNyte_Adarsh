...
module regFile_32x32(	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
  ...
  `ifdef ENABLE_INITIAL_MEM_	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
    reg [31:0] _RANDOM_MEM;	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
    initial begin	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
      `INIT_RANDOM_PROLOG_	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          _RANDOM_MEM = `RANDOM;	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
          Memory[i[4:0]] = _RANDOM_MEM;	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:29:20
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
...
module OctoNyteCPU(	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
      `FIRRTL_BEFORE_INITIAL	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
      automatic logic [31:0] _RANDOM[0:4];	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
      `ifdef INIT_RANDOM_PROLOG_	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
        `INIT_RANDOM_PROLOG_	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
        end	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
        IF_ID = _RANDOM[3'h0];	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7, :19:22
        MEM_WB = _RANDOM[3'h3];	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7, :22:23
        pc = _RANDOM[3'h4];	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7, :25:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
      `FIRRTL_AFTER_INITIAL	// src/main/scala/OctoNyteCore/OctoNyteCPU/OctoNyteCPU.scala:10:7
