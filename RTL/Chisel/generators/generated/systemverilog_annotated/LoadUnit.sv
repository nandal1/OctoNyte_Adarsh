...
module LoadUnit(	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7
  ...
  wire [31:0] io_addr_0 = io_addr;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7
  wire [31:0] io_dataIn_0 = io_dataIn;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7
  wire [2:0]  io_funct3_0 = io_funct3;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7
  wire [1:0]  _loadWidth_T_7 = 2'h2;	// src/main/scala/chisel3/util/Mux.scala:126:16
  wire [31:0] _extractedData_T_5 = io_dataIn_0;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :39:38
  ...
  wire        _GEN = io_funct3_0 == 3'h0;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :28:16
  ...
  wire        _loadWidth_T_1 = io_funct3_0 == 3'h4;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :28:36
  wire        _loadWidth_T_2 = _loadWidth_T | _loadWidth_T_1;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:28:{16,23,36}
  wire        _GEN_0 = io_funct3_0 == 3'h1;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :29:16
  ...
  wire        _loadWidth_T_4 = io_funct3_0 == 3'h5;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :29:36
  wire        _loadWidth_T_5 = _loadWidth_T_3 | _loadWidth_T_4;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:29:{16,23,36}
  wire        _GEN_1 = io_funct3_0 == 3'h2;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :30:16
  ...
  wire [7:0]  _extractedData_T_1 = io_dataIn_0[7:0];	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :37:38
  wire        _extractedData_T_2 = loadWidth == 2'h1;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:24:23, :38:16
  wire [15:0] _extractedData_T_3 = io_dataIn_0[15:0];	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :38:38
  wire        _extractedData_T_4 = loadWidth == 2'h2;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:24:23, :39:16
  wire [31:0] _extractedData_T_6 = _extractedData_T_4 ? _extractedData_T_5 : io_dataIn_0;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :39:{16,38}, src/main/scala/chisel3/util/Mux.scala:126:16
  ...
  wire [31:0] io_dataOut_0 = _io_dataOut_T_4[31:0];	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7, :42:{14,20}
  assign io_dataOut = io_dataOut_0;	// src/main/scala/OctoNyteCore/LoadUnits/LoadUnit.scala:8:7
endmodule
