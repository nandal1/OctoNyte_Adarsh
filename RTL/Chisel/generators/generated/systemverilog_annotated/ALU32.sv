...
module ALU32(	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7
  ...
  wire [31:0] io_a_0 = io_a;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7
  wire [31:0] io_b_0 = io_b;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7
  wire [5:0]  io_opcode_0 = io_opcode;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7
  wire [31:0] _result_T_2 = io_a_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:46
  wire [31:0] _result_T_8 = io_a_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :46:46
  wire [31:0] _result_T_31 = io_a_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :52:46
  wire [31:0] _result_T_37 = io_a_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :53:49
  wire [31:0] _result_T_3 = io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:61
  wire [31:0] _result_T_9 = io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :46:61
  wire [31:0] _result_T_38 = io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :53:63
  wire [3:0]  _result_T = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15
  wire [3:0]  _result_T_6 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :46:15
  wire [3:0]  _result_T_12 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :47:15
  wire [3:0]  _result_T_15 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :48:15
  wire [3:0]  _result_T_18 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :49:15
  wire [3:0]  _result_T_21 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :50:15
  wire [3:0]  _result_T_25 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :51:15
  wire [3:0]  _result_T_29 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :52:15
  wire [3:0]  _result_T_35 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :53:15
  wire [3:0]  _result_T_41 = io_opcode_0[3:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :45:15, :54:15
  ...
  wire [31:0] _result_T_14 = io_a_0 ^ io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :47:46
  wire        _result_T_16 = _result_T_15 == 4'hC;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:48:{15,22}
  wire [31:0] _result_T_17 = io_a_0 | io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :48:46
  wire        _result_T_19 = _result_T_18 == 4'hE;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:49:{15,22}
  wire [31:0] _result_T_20 = io_a_0 & io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :49:46
  wire        _result_T_22 = _result_T_21 == 4'h2;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:50:{15,22}
  wire [5:0]  _result_T_23 = io_b_0[5:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :50:53
  wire [5:0]  _result_T_27 = io_b_0[5:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :50:53, :51:53
  wire [5:0]  _result_T_32 = io_b_0[5:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :50:53, :52:60
  wire [94:0] _result_T_24 = {63'h0, io_a_0} << _result_T_23;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :50:{46,53}
  wire        _result_T_26 = _result_T_25 == 4'hA;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:51:{15,22}
  wire [31:0] _result_T_28 = io_a_0 >> _result_T_27;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :51:{46,53}
  ...
  wire        _result_T_43 = io_a_0 < io_b_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :54:49
  ...
  wire [31:0] io_result_0 = result[31:0];	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7, :62:13, src/main/scala/chisel3/util/Mux.scala:126:16
  assign io_result = io_result_0;	// src/main/scala/OctoNyteCore/ExecutionUnits/ALU32.scala:28:7
endmodule
